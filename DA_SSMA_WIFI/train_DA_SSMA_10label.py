...
class Config:
    def __init__(
        ...
        n_classes: int = 16,
        ft: int = 62,
        save_path: str = 'model_weight/CNN_DA_SSMA_classes_snr_10label_90unlabel_rand30.pth',
        device_num: int = 0,
        rand_num: int = 30,
        ):
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_CNN_DA_SSMA_n_classes_20label_80unlabel_rand30")
