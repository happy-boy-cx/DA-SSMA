...
def Data_prepared(n_classes, rand_num):
    X_train_labeled, X_train_unlabeled, X_train, X_val, value_Y_train_labeled, Y_train_unlabeled, value_Y_train, value_Y_val = TrainDatasetx(n_classes, rand_num)
...
def main():
    ...
    model = torch.load("model_weight/CNN_DA_SSMA_classes_10_10label_90unlabel_rand30.pth",map_location=torch.device('cpu'))
